...
export function ExploreIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MediaIcon({ size = 20, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function VerifiedBadgeIcon({ size = 16, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      <path d="M12 2l2.4 2.8 3.7-.3 1.3 3.4 3.3 1.7-.8 3.6 1.7 3.3-2.8 2.4.3 3.7-3.4 1.3-1.7 3.3-3.6-.8-3.3 1.7-2.4-2.8-3.7.3-1.3-3.4-3.3-1.7.8-3.6-1.7-3.3 2.8-2.4-.3-3.7 3.4-1.3 1.7-3.3 3.6.8L12 2z" />
      <path
        d="m9 12 2 2 4-4"
        fill="none"
        stroke="#ffffff"
