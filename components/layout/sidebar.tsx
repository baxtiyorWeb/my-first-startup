...
const PRIMARY_NAV_ITEMS: NavItemConfig[] = [
  { label: "Bosh sahifa", href: "/dashboard", icon: HomeIcon },
  { label: "Saqlanganlar", href: "/dashboard/bookmarks", icon: BookmarkIcon },
];

const SECONDARY_NAV_ITEMS: NavItemConfig[] = [
  { label: "Profilim", href: "/dashboard/profile", icon: UserIcon },
  { label: "Sozlamalar", href: "/dashboard/settings", icon: SettingsIcon },
];
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden py-3 px-2.5 flex flex-col justify-between scrollbar-none">
          ...
          {/* Bottom Secondary Navigation & User identity */}
            ...
            <div className="pt-2">
              {session.isAuthenticated ? (
                ...
                >
                  ...
                  {!isCollapsed && <span>Tizimga kirish</span>}
                </Link>
              )}
            </div>
          </div>
