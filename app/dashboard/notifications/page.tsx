      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 sm:p-10 space-y-4 shadow-sm">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 max-w-md mx-auto leading-relaxed">
            Fikrlaringiz ostida qoldirilgan yangi tahliliy izohlar, bahslar va siz kuzatayotgan mualliflarning yangi yozuvlari haqidagi xabarnomalar tizimi tez kunda ishga tushiriladi.
          </p>
        </div>
